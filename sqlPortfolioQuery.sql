...
--  This is the part that two tables are joined
-- Total Population vs Vaccinations
-- Shows Percentage of Population that has recieved at least one Covid Vaccine

Select * from Porfolio..CovidDeaths dea
...
Join Porfolio..CovidVaccinations vac
	...
	and dea.date = vac.date
where dea.continent is not null 
and dea.location like 'Phil%' -- Checking the vaccination progress of a specific country
order by 2,3
...
Select *, Round((RollingPeopleVaccinated/Population)*100,4) as Percetage
From PopvsVac
